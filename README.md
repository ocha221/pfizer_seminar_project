...
## Models 
#### 70/20/(10/5) train/validate/test split
### Regression
...
6. Sample `num` ***non-inferred*** entries from within `bin_x` and create synthetic entries till there is equal representation
